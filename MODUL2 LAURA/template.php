...
// **********************  1  ************************** 
$nilai_tinggi_badan = isset($_POST['tinggi_badan']) ? $_POST['tinggi_badan'] : "";
$nilai_berat_badan = isset($_POST['berat_badan']) ? $_POST['berat_badan'] : "";
...
// **********************  2  ************************** 
if ($nilai_berat_badan == 0 || $nilai_berat_badan == "" || $nilai_tinggi_badan == 0 || $nilai_tinggi_badan == "") {
    $error = 'Height and Weight cannot be empty';
}
...
// **********************  3  ************************** 
if (empty($error)) {
    // echo 'Weight: ' . $_POST["nilai_berat_badan"];
    // echo 'Height: ' . $_POST["nilai_tinggi_bedan"];
    $tinggi_badan_m = $nilai_tinggi_badan / 100;
    $BMI = $nilai_berat_badan/($tinggi_badan_m*$tinggi_badan_m);
